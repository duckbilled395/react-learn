    ...
    <BrowserRouter>
      <div className='app-wrapper'>
        ...
        <div className="app-wrapper-content">
          <Routes>
            <Route path='/profile' element={<Profile profilePage={props.state.profilePageReducer} dispatch={props.dispatch}/>}/>
            <Route path='/dialogs' element={<Dialogs messagesPage={props.state} dispatch={props.dispatch}/>}/>
