...
export const profileAPI = {
    ...
    getStatus(userId) {
        return instance.get(`profile/status/${userId}/?client_id=d763110b-a2fc-404a-b74c-6a9bb1d741e8`)
    },
    updateStatus(status) {
        return instance.put(`profile/status/?client_id=d763110b-a2fc-404a-b74c-6a9bb1d741e8`, {status: status})
    }
}
